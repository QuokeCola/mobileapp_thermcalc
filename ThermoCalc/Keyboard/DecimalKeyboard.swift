...
class DecimalKeyboardView: UIView {
    fileprivate func PortraitSetup() {
        ...
        self.backgroundColor = UIColor(red: 214/255, green: 215/255, blue: 220/255, alpha: 1.0)
    ...
    fileprivate func reloadImagineWords() {
        self.ImagineView.backgroundColor = UIColor(red: 214/255, green: 215/255, blue: 220/255, alpha: 1.0)
